<template>
    <Head>
        <title>Report Sales - Aplikasi SIAP</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                ...
                                <div v-if="sales">
                                    ...
                                    <div class="export text-end mb-3">
                                        <a :href="`/apps/sales/export?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-outline-success btn-md border-0 shadow me-3"><i class="fa fa-file-excel"></i> EXCEL</a>
                                        <a :href="`/apps/sales/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-outline-danger btn-md border-0 shadow"><i class="fa fa-file-pdf"></i> PDF</a>
                                    </div>
