<template>
    <Head>
        <title>Report Profits - Aplikasi SIAP</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <button class="btn btn-md btn-outline-success border-0 shadow w-100"><i class="fa fa-filter"></i> FILTER</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div v-if="profits">
                                    ...
                                    <div class="export text-end mb-3">
                                        <a :href="`/apps/profits/export?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-outline-success btn-md border-0 shadow me-3"><i class="fa fa-file-excel"></i> EXCEL</a>
                                        <a :href="`/apps/profits/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-outline-danger btn-md border-0 shadow"><i class="fa fa-file-pdf"></i> PDF</a>
                                    </div>
