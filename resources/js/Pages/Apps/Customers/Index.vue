<template>
    <Head>
        <title>Customers - Aplikasi SIAP</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                <form @submit.prevent="handleSearch">
                                    <div class="input-group mb-3">
                                        <Link href="/apps/customers/create" v-if="hasAnyPermission(['customers.create'])" class="btn btn-outline-danger input-group-text"> <i class="fa fa-plus-circle me-2"></i> NEW</Link>
